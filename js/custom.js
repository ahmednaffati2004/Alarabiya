  ...
  $(document).scroll(function () {
    ...
    if ($(".team-slider")[0]){
        $('.team-slider.owl-carousel').owlCarousel({
            ...
            loop: true,
            nav:true,
            navText: ["<i class='fa-solid fa-angles-left'></i>","<i class='bi bi-arrow-right'></i>"],
            dots: false,
            touchDrag  : false,
            mouseDrag  : false,
            center: true,
    ...
    if ($(".f-slider-one")[0]){
        $('.f-slider-one.owl-carousel').owlCarousel({
            ...
            stagePadding: 0,
            nav:true,
            navText: ["<button><i class='fa-solid fa-angles-left'></i></button>","<button><i class='bi bi-arrow-right'></i></button>"],
            dots: false,
            animateOut: 'fadeOut',
            touchDrag  : false,
            mouseDrag  : false
